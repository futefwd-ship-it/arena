//Pavilion TowerData
// floor 2D and 3D floor type-1
import floorImg from '../assets/stadia/Typical/iso3D/TOWERPLAN.jpg';
import floor3D1 from '../assets/stadia/Typical/iso3D/TOWERPLAN.jpg';
// unit-1 ,2,3,4
import floorunit1 from '../assets/stadia/Typical/iso3D/FLAT 1.jpg';
import floorunit2 from '../assets/stadia/Typical/iso3D/FLAT 2.jpg';
import floorunit3 from '../assets/stadia/Typical/iso3D/FLAT 3 ISO.jpg';
...
import floorunit3D4 from '../assets/Towers/type-1/Units/3D/FLAT4.jpg';



// floor 2D and 3D floor type-2
...
export const floorsData = [
    { id: 1, top: "86.5%", polygon: "1072,1559,1072,1588,1302,1591,1302,1560", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 2", height: 15, width: 148 },
    { id: 2, top: "84.9%", polygon: "1078,1529,1078,1558,1308,1561,1308,1530", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 3", height: 14, width: 148 },
    { id: 3, top: "83.2%", polygon: "1072,1502,1072,1531,1302,1534,1302,1503", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 4", height: 13, width: 148 },
    {
        id: 4, top: "81.5%", polygon: "1075,1473,1075,1502,1305,1505,1305,1474", left: "40%", hoverColor: "rgba(255,165,0,0.5)",
        name: "Floor 5", height: 13, width: 148
    },
    { id: 5, top: "80%", polygon: " 1084,1445,1084,1474,1314,1477,1314,1446", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 6", height: 15, width: 148 },
    { id: 6, top: "78.3%", polygon: "1087,1414,1087,1443,1317,1446,1317,1415 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 7", height: 13, width: 148 },
    { id: 7, top: "76.7%", polygon: "1084,1386,1084,1415,1314,1418,1314,1387 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 8", height: 13, width: 148 },
    { id: 8, top: "75.2%", polygon: "1083,1359,1083,1388,1313,1391,1313,1360 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 9", height: 14, width: 148 },
    { id: 9, top: "73.6%", polygon: "1080,1332,1080,1361,1310,1364,1310,1333 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 10", height: 14, width: 148 },
    { id: 10, top: "72%", polygon: "1088,1304,1088,1333,1318,1336,1318,1305", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 11", height: 13, width: 148 },
    { id: 11, top: "70.4%", polygon: "1082,1273,1082,1302,1312,1305,1312,1274", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 12", height: 14, width: 148 },
    { id: 12, top: "68.8%", polygon: "1088,1242,1088,1271,1318,1274,1318,1243 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 13", height: 15, width: 148 },
    { id: 13, top: "67.2%", polygon: "1088,1219,1088,1248,1318,1251,1318,1220 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 14", height: 15, width: 148 },
    { id: 14, top: "65.6%", polygon: "1086,1188,1086,1217,1316,1220,1316,1189 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 15", height: 15, width: 148 },
    { id: 15, top: "64%", polygon: "1083,1158,1083,1187,1313,1190,1313,1159", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 16", height: 15, width: 148 },
    { id: 16, top: "62.4%", polygon: "1083,1131,1083,1160,1313,1163,1313,1132", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 17", height: 15, width: 148 },
    { id: 17, top: "60.8%", polygon: " 1086,1104,1086,1133,1316,1136,1316,1105", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 18", height: 13, width: 148 },

    { id: 18, top: "59.2%", polygon: " 1083,1075,1083,1104,1313,1107,1313,1076", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 19", height: 15, width: 148 },
    { id: 19, top: "57.5%", polygon: "1083,1046,1083,1075,1313,1078,1313,1047 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 20", height: 15, width: 148 },
    { id: 20, top: "56%", polygon: "1086,1021,1086,1050,1316,1053,1316,1022 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 21", height: 13, width: 148 },

    { id: 21, top: "54.4%", polygon: "1089,989,1089,1018,1319,1021,1319,990 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 22", height: 13, width: 148 },
    { id: 22, top: "52.8%", polygon: "1086,961,1086,990,1316,993,1316,962 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 23", height: 15, width: 148 },
    { id: 23, top: "51.2%", polygon: "1083,930,1083,959,1313,962,1313,931 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 24", height: 15, width: 148 },
    { id: 24, top: "49.6%", polygon: " 1083,905,1083,934,1313,937,1313,906", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 25", height: 13, width: 148 },
    { id: 25, top: "48.1%", polygon: "1080,875,1080,904,1310,907,1310,876 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 26", height: 16, width: 148 },
    { id: 26, top: "46.5%", polygon: " 1080,844,1080,873,1310,876,1310,845", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 27", height: 17, width: 148 },
    { id: 27, top: "44.8%", polygon: "1080,815,1080,844,1310,847,1310,816 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 28", height: 16, width: 148 },
    { id: 28, top: "43%", polygon: "1080,788,1080,817,1310,820,1310,789 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 29", height: 15, width: 148 },

    { id: 29, top: "41.6%", polygon: "1080,761,1080,790,1310,793,1310,762 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 30", height: 15, width: 148 },
    { id: 30, top: "40%", polygon: "1069,731,1069,760,1299,763,1299,732 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 31", height: 15, width: 148 },
    // // Add more floors as needed

    { id: 31, top: "38.4%", polygon: " 1069,704,1069,733,1299,736,1299,705", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 32", height: 14, width: 148 },
    { id: 32, top: "36.8%", polygon: " 1075,677,1075,706,1305,709,1305,678", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 33", height: 14, width: 148 },
    { id: 33, top: "35.1%", polygon: "1075,647,1075,676,1305,679,1305,648 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 34", height: 14, width: 148 },
    { id: 34, top: "33.7%", polygon: " 1071,620,1071,649,1301,652,1301,621", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 35", height: 14, width: 148 },
    { id: 35, top: "32%", polygon: "1074,588,1074,617,1304,620,1304,589 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 36", height: 16, width: 148 },
    { id: 36, top: "30.3%", polygon: "1068,564,1068,593,1298,596,1298,565 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 37", height: 13, width: 148 },
    { id: 37, top: "28.9%", polygon: "1068,533,1068,562,1298,565,1298,534 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 38", height: 17, width: 148 },
    { id: 38, top: "27.2%", polygon: "1068,506,1068,535,1298,538,1298,507 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 39", height: 14, width: 148 },
    { id: 39, top: "25.6%", polygon: "1068,475,1068,504,1298,507,1298,476 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 40", height: 14, width: 148 },
    { id: 40, top: "24%", polygon: "1065,444,1065,473,1295,476,1295,445 ", left: "40%", hoverColor: "rgba(255,165,0,0.5)", name: "Floor 41", height: 14, width: 148 }
...
export const floors = [
        ...
        units: [
            {
                ...
                polygonPoints:
                    "1249,407,1236,451,1174,456,1112,721,1072,875,1311,875,1320,919,1390,919,1390,875,1470,880,1447,1012,1805,1021,1801,1109,1884,1109,1902,959,2043,968,2052,919,2502,915,2507,681,2467,677,2462,721,2414,721,2405,685,2370,668,2370,597,2317,597,2312,646,2132,646,2114,597,2079,588,2087,420,2048,420,2048,394,1845,398,1831,420,1739,416,1726,460,1531,465,1531,425,1452,425,1452,407",
            ...
            },
            {
                ...
                polygonPoints:
                    "2511,672,2511,915,2785,915,2979,915,2979,977,3138,981,3142,1021,3575,1021,3557,880,3628,880,3628,919,3703,919,3698,880,3950,871,3848,420,3778,416,3778,403,3583,403,3597,451,3508,447,3508,429,3486,465,3301,460,3283,425,3195,416,3195,398,2974,394,2983,451,2935,456,2944,601,2913,597,2908,650,2714,650,2710,601,2643,606,2648,672",
...

   {
    ...
    // ....8th,13,18,23,28,33, floor type-2
    {
        id: 7,
        title: "FLOOR-8",
        image: floorImgType2,
        image1: floor3D1Type2,
        imageSettings: {
            svgSize: "0 0 5000 2813",
            imageWidth: "5000",
            imageHeight: "2813",
