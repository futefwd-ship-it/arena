...
export default function Unit_Grandstand() {
  ...
  return (
    <>
      <section className="flex gap-2 lg:flex-row flex-col overflow-auto lg:overflow-hidden h-screen w-full p-2 bg-[#e8e8e8] select-none">
        <WithoutbgHeader />

        {/* Left sidebar - rooms list for whichever layout */}
        <div className="lg:w-[20%] w-full mt-20 justify-center flex flex-col border-r p-4 rounded-lg lg:mt-4 h-screen">
