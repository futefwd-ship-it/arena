...
import { floors } from '../../data/GrandstandData';

import WithoutbgHeader from '../../components/WithoutbgHeader';

export default function Floor_Pavilion() {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen w-full p-5 gap-6 overflow-hidden bg-[#E8E8E8]">
            <WithoutbgHeader />
            {/* Left Sidebar */}
            <div className="md:w-[50%] lg:w-[35%] xl:w-[20%] mt-12 mb-2 w-full flex flex-col items-center justify-center border-r p-4 overflow-y-auto">
            ...
            `}
                ...
                <div className="mt-3 w-full flex flex-col gap-2 p-1 text-[14px]">
                    ...
                    {singleFloor.units.map((unit) => (
                        ...
                        >
                            <polygon
                                ...
                                onMouseEnter={() => setHoveredUnit(unit.id)}
                                onMouseLeave={() => setHoveredUnit(null)}
                                onDoubleClick={() => navigate(`/arena_unitgrandstand/${unit.id}`)}
                            />
                        </Tooltip>
                    ))}
                </svg>
