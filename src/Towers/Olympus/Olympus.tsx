  ...
  return (
     ...
     */}
      ...
      <img
        ...
        className="absolute inset-0 w-full h-full object-contain lg:object-cover object-bottom"
      ...
      <svg
        ...
        */
        ...
        preserveAspectRatio={isLargeScreen ? "xMidYMax slice" : "xMidYMax meet"}
        ...
        {floorsData.map((floor: any, _index) => {
          ...
          return (
            <polygon
              ...
              data-tooltip-id={`tooltip-${floor.id}`}
              fill={isActive ? "#E8941A" : "transparent"}
              fillOpacity={isActive ? 0.4 : 0}
              // stroke={isActive ? "#E8941A" : "transparent"}
              strokeWidth={isActive ? "2" : "0"}
              strokeOpacity={isActive ? 0.8 : 0}
              className="cursor-pointer transition-all duration-300 focus:outline-none outline-none"
              style={{
                filter: isActive
                  ? "drop-shadow(0 0 6px rgba(232,148,26,0.4))"
                  : "none",
              }}
