import bgImage from '../../assets/entrance_tower/Atheletica_interface.jpg';
...
import { floorsData, description } from '../../data/AthleticaData';

export default function Athletica() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden flex justify-center items-center">
      ...
      {/* Background Image */}
      <img src={bgImage} alt="Arena" className="w-full h-full " />
      ...
      {/* Content Box */}
      <div className="absolute z-20 bottom-16 right-2 p-10 bg-black/60 rounded-xl max-w-lg text-center text-white">
