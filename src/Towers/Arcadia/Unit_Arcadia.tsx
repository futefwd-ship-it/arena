...
import { floors } from '../../data/ArcadiaData';
...
export default function Unit_Arcadia() {
  ...
  return (
    <>
      <section className="flex flex-col lg:flex-row gap-2 overflow-auto lg:overflow-hidden h-screen w-full p-2 bg-[#e8e8e8] select-none">
            ...
            {(activeLayout === "default" ? singleUnit.rooms : singleUnit.roomstatic)?.map((room: any, index: number) => {
              ...
              return (
                <div
                  ...
                  // onClick={()=>() => isDefaultLayout ? setHoveredRoomDefault(room.id) : setHoveredRoom2D(room.id)}
        ...
        <div className="lg:w-[65%] w-ull justify-center h-screen items-center flex">
                ...
                {singleUnit.rooms.map((room: any) => (
                  ...
                  >
                    <polygon
                      ...
                      onClick={()=>setSelectedRoom2D(room.id)}
