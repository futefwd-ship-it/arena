import bgImage from '../../assets/twr/citadel.jpg';
import { IoReturnUpBackOutline } from "react-icons/io5";

import { useNavigate } from 'react-router-dom';
import { useState } from 'react';
import { Tooltip } from 'react-tooltip';
import { floorsData, description } from '../../data/CitatelData';
export default function Citatel() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden flex justify-center items-center">
      ...
      {/* Content Box */}
      <div className="absolute z-20 bottom-16 md:bottom-52 lg:bottom-16 right-20 md:right-5 lg:right-2 p-10 bg-black/60 rounded-xl max-w-lg text-center text-white">
