...
export default function Floor_Greenfield() {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen w-full p-5 gap-6 overflow-hidden bg-[#E8E8E8]">
            <WithoutbgHeader />
            {/* Left Sidebar */}
            <div className="lg:w-[30%] xl:w-[20%] md:w-[50%] mb-2 mt-20 md:mt-5  w-full flex flex-col items-center justify-center border-r p-4 overflow-y-auto">
                ...
                >
                    ...
                    {singleFloor?.units.map((unit) => (
                        <ul key={unit.id}>
                            <li
                                className={`
                cursor-pointer transition-transform duration-200 mt-1 flex p-1 rounded-sm justify-between border-b pb-2 text-[12px]
                    ...
                    {singleFloor.units.map((unit) => (
                        ...
                        >
                            <polygon
                                ...
                                onMouseEnter={() => setHoveredUnit(unit.id)}
                                onMouseLeave={() => setHoveredUnit(null)}
                                onDoubleClick={() => navigate(`/arena_unitgreenfield/${unit.id}`)}
                            />
                        </Tooltip>
                    ))}
                </svg>
